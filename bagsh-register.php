<!DOCTYPE html>
<html lang="en">
<?php require_once 'config/bagsh-registering.php'; ?>
<head>
...
<body class="fix-menu">
                        ...
                        <form class="md-float-material" action = "" method = "post" enctype="multipart/form-data">
                            ...
                            <div class="auth-box">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-center txt-primary">Багш бүртгүүлэх хуудас</h3>
                                    </div>
                                </div>
                                <hr/>
 ...
 oninput="setCustomValidity('')">
                                ...
                                <div class="input-group">
                                    <input type="text" name="utas" class="form-control" placeholder="Утасны дугаар" required oninvalid="this.setCustomValidity('Заавал мэдээлэл оруулах шаардлагатай')"
 oninput="setCustomValidity('')">
                                    <span class="md-line"></span>
                                </div>
                                <div class="input-group">
 ...
 oninput="setCustomValidity('')" onfocus="(this.type='file')">
                                ...
                                <div class="input-group">
                                    <input type="token" name="token" class="form-control" placeholder="Бүртгүүлэх нууц код" required oninvalid="this.setCustomValidity('Заавал мэдээлэл оруулах шаардлагатай')"
 oninput="setCustomValidity('')">
                                    <span class="md-line"></span>
                                </div>
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20" name = "bagsh-register">Бүртгүүлэх</button>
                                    </div>
